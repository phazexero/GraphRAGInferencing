...
class GraphBuilder():
    ...
    def __init__(self):
        ...
        self.llm = Together(api_key = "TOGETHER_KEY", model = "meta-llama/Meta-Llama-3.1-8B-Instruct-Turbo")
        # self.llm = ChatGroq(groq_api_key = "GROQ_KEY", model_name = "llama3-8b-8192")
